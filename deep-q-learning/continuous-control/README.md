...
2. For a clean space to play and develop your own solution clone the repository (if you haven't already!), and navigate to the `python/` folder.  Then, install several dependencies.
    ```bash
    ...
    Otherwise you can clone this repo and use it in the same way.
...
Otherwise ou can use the `Continuous_Control.ipynb` file that is in this repository to recreate the results. 